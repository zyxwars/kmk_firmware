...
keymap = [
    ...
    [   # COLEMAK-DH
        ...
        KC.LCTL, GUI,     KC.LALT, KC.F12,  FN,      KC.SPC,  KC.DEL,         ENTFN,   _______, FN,      KC.LEFT, KC.DOWN, KC.UP,   KC.RIGHT
    ],
    [   # FN
    ...
    [   # GAMING
        ...
        KC.TAB,  KC.Q,    KC.W,    KC.E,    KC.R,   KC.T,     KC.H,           KC.RBRC, KC.Y,    KC.U,    KC.I,    KC.O,    KC.P,    KC.EQUAL,
        KC.BSPC, KC.A,    KC.S,    KC.D,    KC.F,   KC.G,     KC.M,           _______, KC.H,    KC.J,    KC.K,    KC.L,    KC.SCLN, KC.QUOT,
        KC.LSFT, KC.Z,    KC.X,    KC.C,    KC.V,   KC.B,     _______,        _______, KC.N,    KC.M,    KC.COMMA,KC.DOT,  KC.SLASH,SFTBSLS,
        _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______,
    ],
    [   # VIM
        _______, _______, _______, _______, _______, _______, _______,       _______,  _______, _______, _______, _______, _______, _______,
        _______, KC.Q,    KC.W,    KC.E,    KC.R,    KC.T,    KC.H,          KC.RBRC, KC.Y,    KC.U,    KC.I,     KC.O,    KC.P,    KC.EQUAL,
        _______, KC.A,    KC.S,    KC.D,    KC.F,    KC.G,    KC.M,          _______, KC.LEFT, KC.DOWN, KC.UP,    KC.RIGHT,KC.SCLN, KC.QUOT,
        VIMOUT,  KC.Z,    KC.X,    KC.C,    KC.V,    KC.B,    _______,       _______, KC.N,    KC.M,    KC.COMMA, KC.DOT,  KC.SLASH,SFTBSLS,
        _______, _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______, _______,
    ]
]
